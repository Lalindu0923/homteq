...
$pagename="SignUp Result"; //Create and populate a variable called $pagename
...
echo "<br><p><i>Go back to <a href=signup.php>sign up</i></a></p>";
echo "<br><br><br><br>";
}
