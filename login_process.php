...
session_start();
include("db.php");
$email = $_POST['l_email'];  // Retrieve email from form input
$password = $_POST['l_password'];  // Retrieve password from form input
//include("login.php");
$pagename="loging Page"; //Create and populate a variable called $pagename
